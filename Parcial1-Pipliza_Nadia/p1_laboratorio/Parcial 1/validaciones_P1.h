#ifndef VALIDACIONES_TP2_H_
#define VALIDACIONES_TP2_H_
#ifndef VALIDACIONES_TP2_H_INCLUDED
#define VALIDACIONES_TP2_H_INCLUDED
 ...
 *
 */
float getFloatNew(float str[],char message[],char errorMessage[]);
